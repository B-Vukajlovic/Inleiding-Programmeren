...
// Dit programma is opgegeven voor competitie door de recusieve functie die erg efficient te werk gaat en in mijn opninie beter werkt dan veel andere programma's, en dus deze ook zal verslaan
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
